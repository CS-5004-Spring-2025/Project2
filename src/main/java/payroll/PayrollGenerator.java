 ...
 * <p>
 * You are free to modify this file as needed, but it is required that you support the following two options for
 * executing the program from the command line:
 * <p>
 * java payroll.PayrollGenerator -e employees_mine.csv -t time_cards.csv -o pay_stubs_mine.csv or java
 * payroll.PayrollGenerator The above defaults listed below.
 * <p>
 * Grading wise, we will both be using unit tests, and running your program with different employee files.
 * <p>
 *
 **/
public final class PayrollGenerator {
    ...
    public static void main(String[] args) {
        ...
        employeeLines = employees.stream().map(Employee::toCsv).collect(Collectors.toList());
        ...
        List<String> payStubLines = payStubs.stream().filter(x -> x != null).map(PayStub::toCsv)
                .collect(Collectors.toList());
    ...
    /**
     * This is an internal class. Please leave it as is/do not modify! This design is common for processing arguments if
     * you want to make sure it is unique to the driver.
     */
